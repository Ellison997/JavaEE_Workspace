...
<%
   request.setCharacterEncoding("UTF-8");
    String tnumber=new String(request.getParameter("tnumber").getBytes("ISO-8859-1"),"UTF-8");
  ...
  <div class="row-fluid">
    ...
    <div class="well">
      ...
      <div id="myTabContent" class="tab-content">
		...
		<form id="tab" method="post" action="/mvcDorm/Teacher_DoUpdate" autocomplete="off">
          <label>教师编号</label>
          <input type="text" name="tnumber" value="<%=tnumber %>" class="input-xlarge" autofocus="true" required="true" >
          <label>教师姓名</label>
          <input type="text" name="tname" value="<%=tname%>" class="input-xlarge" required="true" >
          <label>性别</label>
          ...
          <input type="text" name="tphone" value="" class="input-xlarge" required pattern="\d{11}" >
            <label>管理楼层</label>
          <input type="text" name="tmanage" value="" class="input-xlarge" autofocus="true"  >
          <label>学院</label>
